...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "spcmastertim-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tsqclass"
  #   chef.validation_client_name = "tsqclass-validator"
  #   chef.validation_key_path = ".chef/tsqclass-validator.pem"
  # end
end
